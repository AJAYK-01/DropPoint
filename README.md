...
- Mac
  - Download `DropPoint-1.x.x-universal.dmg` or `DropPoint-1.x.x-universal-mac.zip` from Releases and install. right click or ```Ctrl``` + click on the App, click open and then "Open" in the dialog box when running the first time.
- Linux
